...
$relatedProfessors= new WP_Query(array(
        'posts_per_page'  =>  -1,
        'post_type' => 'professor',
        'orderby' => 'title', //additional data value ie meta data
        'order' =>  'ASC',
        'meta_query' => array(
         
          array(
            'key' => 'related_programs', //array(12,102,1239) php serialize this
            'compare' => 'LIKE',
            'value' => '"' . get_the_ID() . '"' //serialized array
          )
        )
      ));
...
wp_reset_postdata(  );
        ...
        'post_type' => 'event',
        'meta_key' => 'event_date',
        'orderby' => 'meta_value_num', //additional data value ie meta data
        'order' => 'ASC',
        'meta_query' => array(
        array(
        'key' => 'event_date',
